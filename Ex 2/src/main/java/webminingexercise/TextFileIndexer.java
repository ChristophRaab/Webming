...
public class TextFileIndexer {
	...
	public static void main(String[] args) throws IOException {
		...
		try {
			...
			// try to add file into the index. Add your path to the data. Located in src/main/resources
			indexer.indexFileOrDirectory(
					"\to\data\location");
		} catch (Exception e) {
